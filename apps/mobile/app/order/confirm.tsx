...
export default function OrderConfirmScreen() {
      ...
      ? [
          {
            ...
            coverUrl: productQuery.data.coverUrl,
    ...
    try {
      const order = await create.mutateAsync(
        params.productId
          ...
          : {
              source: 'cart',
              cartItemIds: params.cartItemIds?.split(',') || [],
              address: '北京市朝阳区测试地址',
            },
      )
  ...
  if (productQuery.isLoading || cartQuery.isLoading) return <LoadingView />
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#fff' }}>
          ...
          {items.map((item) => (
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text
                  style={{ marginTop: 8, color: '#e43d33', fontWeight: '800' }}
                >
      ...
      <TouchableOpacity
        ...
        style={{
          ...
          height: 52,
          borderRadius: 8,
          backgroundColor: items.length === 0 ? '#ccc' : '#e43d33',
          alignItems: 'center',
