...
export function FeedItem({
  ...
  const videoWidth =
    screenAspect > videoAspect ? screenHeight * videoAspect : screenWidth
  const videoHeight =
    screenAspect > videoAspect ? screenHeight : screenWidth / videoAspect
  const videoBoxStyle = {
  ...
  return (
    ...
    >
      <Video
        ...
        videoStyle={
          Platform.OS === 'web'
            ? ({ objectPosition: 'center center' } as never)
            : undefined
        }
      />
      <View
        ...
        {product ? (
          ...
          >
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text
                style={{ color: '#e43d33', fontWeight: '800', marginTop: 4 }}
              >
