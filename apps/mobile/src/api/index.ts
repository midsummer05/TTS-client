...
import type { CartItem, Comment, LiveRoom, MessageItem, Order, Product, User, VideoItem } from '@/types'

export const api = {
  login: (nickname: string) => request.post('/auth/mock-login', { nickname }) as Promise<{ token: string; user: User }>,
